...
def main() -> None:
    ...
    parser.add_argument("--interval-minutes", type=int, default=15, help="Interval minutes for compute jobs")
    ...
    scheduler.add_job(job_ingest, "interval", minutes=max(60, args.interval_minutes), id="ingest_prices", replace_existing=True)
    scheduler.add_job(job_compute, "interval", minutes=args.interval_minutes, id="compute_all", replace_existing=True)
